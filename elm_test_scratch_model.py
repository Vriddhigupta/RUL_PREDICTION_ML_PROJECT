...
import elm_scratch_model as elm
from sklearn.preprocessing import StandardScaler
import matplotlib.pyplot as plt

stdsc = StandardScaler()
# built model and train
model = elm.elm(hidden_units=32, activation_function='relu', random_type='normal', x=X_train, y=y_train, C=0.1, elm_type='reg')
beta, train_accuracy, running_time = model.fit('solution2')
print("regression beta:\n", beta)
print("train accuracy (RSME):", train_accuracy)
...
print(f'RSME Score: {model.score(X_test,prediction)}')
